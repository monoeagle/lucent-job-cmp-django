...
!!! warning "Internes Arbeitsdokument"
    Diese Seite ist **nicht Teil der ausgelieferten Dokumentation** und wird beim
    Bau des Docs-ZIP ausgeschlossen. Sie enthält eine ungeschönte Bewertung des
    eigenen Systems inklusive offener Schwachstellen und dient der internen
