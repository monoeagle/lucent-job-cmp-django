...
CMP verwendet Stubs für externe Systeme, die in der Entwicklung nicht verfügbar sind. Stubs haben das gleiche Interface wie die Live-Implementierung — der Wechsel erfolgt über ein Setting.

## CMDB Stub

**Klasse:** `apps.cmdb.clients.CmdbStubClient`
**Daten:** `cmp/stubs/cmdb/`
