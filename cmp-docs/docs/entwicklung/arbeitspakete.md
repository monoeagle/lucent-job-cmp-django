...
Status: **AP-0 … AP-10 fertig** (Backend B0–B9 + HTMX-Frontend), **AP-22 erledigt**
(Zugriffskontrolle) und **AP-13 erledigt** (Bestellkette verdrahtet) — 366 Tests grün, v1.5.0.
**AP-11, AP-12, AP-14 … AP-21 und AP-23 offen**.
...
Empfohlene Reihenfolge: **15 → 14 → 16+17 → 18 → 19 → 20 → 21**, AP-23 nebenher.
AP-13 (Vorrang) ist mit v1.5.0 erledigt und hat die Auslösepunkte geschaffen, auf denen
AP-18 (E-Mail) und AP-20 (echter GitLab-Client) nun aufsetzen können.
...
> AP-**Reihenfolge** ist real, die Tagesspannen illustrieren nur den Ablauf. Für AP-14 … AP-21
> sind die Spannen **Schätzungen**, keine Zusagen.
> Offen: AP-11, AP-12 sowie AP-14 … AP-21 und AP-23 (siehe Tabelle oben).
