...
Das **Marketplace Portal** ermöglicht Benutzern, IT-Services (VMs, Datenbanken, Container) aus einem Katalog zu bestellen. Ein regelbasierter Approval-Workflow steuert die Genehmigung, und ein Provisioning-Engine (Celery + GitLab) erstellt die Ressourcen automatisch.
